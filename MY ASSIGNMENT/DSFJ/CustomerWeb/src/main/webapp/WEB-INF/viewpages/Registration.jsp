						...
						$('#btnSUBMIT')
								.click(
										function() {
											...
											$
													.ajax({
														url : 'http://locaffflhost:8080/CustomerWeb/web/customer/customerregistration',
														type : 'post',
														data : {
															"name" : $('#name')
																	.val(),
																	...
																	.each(
																			...
																			function(
																				...
																				$(
																						"#tblGrid tbody")
																						.append(
																								"<tr id="+customer.id+"><td><input name='rd' type='radio' value='"+customer.id+"'/></td><td>"
																										+ customer.id
																										+ "</td><td>"
																										+ customer.name
																										+ "</td><td>"
																										+ customer.emailId
																										+ "</td><td><input type='button' id='btnEdit' value='EDIT'/></td><td><input type='button' id='btnDelete' value='DELETE'/></td>");
																			});
