...
<title>
	<spring:message code="SearchCustomer.title" /> 
</title>
...
<spring:url var="angularurl" value="/components/angular/angular.js" />
<script type="text/javascript" src="${angularurl}"></script>
